    ...
    class Coordinator: NSObject, MKMapViewDelegate {
        func mapView(_ mapView: MKMapView, viewFor annotation: MKAnnotation) -> MKAnnotationView? {
            if let strikeAnnotation = annotation as? StrikeAnnotation {
                ...
                iconView.tintColor = strikeAnnotation.isLatest ? .systemYellow : .systemYellow.withAlphaComponent(0.6)
                ...
                backgroundView.layer.borderColor = strikeAnnotation.isLatest ? UIColor.systemYellow.withAlphaComponent(0.8).cgColor : UIColor.systemYellow.withAlphaComponent(0.4).cgColor
